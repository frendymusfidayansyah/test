...
<head>
    ...
    <!-- Perbaikan: Quicksand diganti menjadi Quicksand (font yang benar) -->
    <link
    ...
    <style>
        /* ===== RESET & BASE ===== */
        * {
            margin: 0;   /* Perbaikan: sebelumnya margin:30 tanpa satuan */
            padding: 0;  /* Perbaikan: sebelumnya padding:60 tanpa satuan */
            box-sizing: border-box;
        }

        body {
            font-family: 'Quicksand', sans-serif; /* Perbaikan: Quicksand -> Quicksand */
            background: #0c0518;
            color: #fff;
            min-height: 100vh;
            overflow-x: hidden;
        ...
        .prestasi-card:hover {
            border-left-color: #ff6bcd;
            box-shadow: 0 8px 30px rgba(255, 107, 205, 0.15);
        ...
        /* ===== PRESTASI GRID CARD (baru, lebih menarik) ===== */
        .prestasi-grid {
            display: grid;
        ...
        /* Class untuk menyembunyikan elemen hanya di mobile (digunakan <br>) */
        @media (max-width: 768px) {
            .hide-on-mobile {
                display: none;
            }
            ...
            <section id="divisi">
                ...
                <div class="collage-grid">
                    ...
                    <div class="collage-item" style="background: linear-gradient(135deg, rgba(255,231,74,0.25), rgba(255,231,74,0.08));">
                        <div class="media"><img src="POSTER DIVISI FOTOGRAFI.png" alt="Divisi Fotografi" loading="lazy" /></div>
                        ...
                        <button class="btn btn-sm btn-klik" style="font-size:0.6rem; padding:4px 12px; margin-top:8px;" data-bs-toggle="modal" data-bs-target="#imageOnlyModal" data-image="POSTER DIVISI FOTOGRAFI.png">LIHAT KARTU</button>
                    </div>
                    ...
                    <div class="collage-item" style="background: linear-gradient(135deg, rgba(227,0,11,0.25), rgba(227,0,11,0.08));">
                        <div class="media"><img src="POSTER DIVISI SINEMATOGRAFI.png" alt="Divisi Cinema" loading="lazy" /></div>
                        ...
                        <button class="btn btn-sm btn-klik" style="font-size:0.6rem; padding:4px 12px; margin-top:8px;" data-bs-toggle="modal" data-bs-target="#imageOnlyModal" data-image="POSTER DIVISI SINEMATOGRAFI.png">LIHAT KARTU</button>
                    </div>
                    <!-- Divisi 3: Radio -->
                    <div class="collage-item" style="background: linear-gradient(135deg, rgba(0,109,183,0.25), rgba(0,109,183,0.08));">
                        <div class="media"><img src="POSTER DIVISI RADIO.png" alt="Divisi Radio" loading="lazy" /></div>
                        ...
                        <button class="btn btn-sm btn-klik" style="font-size:0.6rem; padding:4px 12px; margin-top:8px;" data-bs-toggle="modal" data-bs-target="#imageOnlyModal" data-image="POSTER DIVISI RADIO.png">LIHAT KARTU</button>
                    </div>
                    ...
                    <div class="collage-item" style="background: linear-gradient(135deg, rgba(255,107,205,0.25), rgba(255,107,205,0.08));">
                        <div class="media"><img src="POSTER DIVISI MADES.png" alt="Divisi Mading & Desain" loading="lazy" /></div>
                        ...
                        <button class="btn btn-sm btn-klik" style="font-size:0.6rem; padding:4px 12px; margin-top:8px;" data-bs-toggle="modal" data-bs-target="#imageOnlyModal" data-image="POSTER DIVISI MADES.png">LIHAT KARTU</button>
                    </div>
                    <!-- Divisi 5: Jurnalistik -->
                    <div class="collage-item" style="background: linear-gradient(135deg, rgba(0,163,78,0.25), rgba(0,163,78,0.08));">
                        <div class="media"><img src="POSTER DIVISI JURNALISTIK .jpg" alt="Divisi Jurnalistik" loading="lazy" /></div>
                        ...
                        <button class="btn btn-sm btn-klik" style="font-size:0.6rem; padding:4px 12px; margin-top:8px;" data-bs-toggle="modal" data-bs-target="#imageOnlyModal" data-image="POSTER DIVISI JURNALISTIK .jpg">LIHAT KARTU</button>
                    </div>
                </div>
            </section>
            ...
            <section id="prestasi">
                ...
                <div class="prestasi-grid">
                    ...
                    <div class="prestasi-item">
                        ...
                        <h5>Best National Student Short Fiction untuk film "We Don't Know the Title
Yet" – IMAC Film Festival 2026 Universitas Indonesia (UI)</h5>
                        <div class="desc">Penghargaan tingkat nasional dalam bidang pembuatan film pendek universitas Indonesia</div>
                        <button class="btn-lihat-sertifikat" data-bs-toggle="modal" data-bs-target="#imageOnlyModal" data-image="WhatsApp Image 2026-06-30 at 07.31.02.jpeg">📜 Lihat lebih lanjut</button>
                    </div>
                    <!-- Prestasi 2 -->
                    <div class="prestasi-item">
                        <div class="icon-trophy"><i class="fas fa-medal"></i></div>
                        <h5>Juara 1 Short Movie Honda</h5>
                        <div class="desc">Memenangkan lomba Short Movie tingkat provinsi oleh Honda Motor.</div>
                        <button class="btn-lihat-sertifikat" data-bs-toggle="modal" data-bs-target="#imageOnlyModal" data-image="prestasi_honda.jpg">📜 Lihat lebih lanjut</button>
                    </div>
                    <!-- Prestasi 3 -->
                    <div class="prestasi-item">
                        <div class="icon-trophy"><i class="fas fa-medal"></i></div>
                        <h5>Sub-Organisasi Terbaik 2025</h5>
                        <div class="desc">Penghargaan atas inovasi pembelajaran berbasis teknologi.</div>
                        <button class="btn-lihat-sertifikat" data-bs-toggle="modal" data-bs-target="#imageOnlyModal" data-image="prestasi_terbaik2025.jpg">📜 Lihat lebih lanjut</button>
                    </div>
                    <!-- Prestasi 4 (Baru) -->
                    <div class="prestasi-item">
                        <div class="icon-trophy"><i class="fas fa-medal"></i></div>
                        <h5>Juara Harapan 1 Fotografi</h5>
                        <div class="desc">Lomba fotografi tingkat DKI Jakarta dengan tema "Remaja Kreatif".</div>
                        <button class="btn-lihat-sertifikat" data-bs-toggle="modal" data-bs-target="#imageOnlyModal" data-image="prestasi_fotografi.jpg">📜 Lihat lebih lanjut</button>
                    </div>
                    <!-- Prestasi 5 (Baru) -->
                    <div class="prestasi-item">
                        <div class="icon-trophy"><i class="fas fa-medal"></i></div>
                        <h5>Penghargaan Kreativitas Digital</h5>
                        <div class="desc">Kategori desain grafis dan konten media sosial terbaik tingkat kota.</div>
                        <button class="btn-lihat-sertifikat" data-bs-toggle="modal" data-bs-target="#imageOnlyModal" data-image="prestasi_digital.jpg">📜 Lihat lebih lanjut</button>
                    </div>
                </div>
            </section>
            ...
            <section id="daftar">
                ...
                <div class="daftar-section">
                    <div class="daftar-content">
                        <h2><i class="fas fa-user-plus"></i> GABUNG MEDIKOM! <i class="fas fa-user-plus"></i></h2>
                        <p>
                            Ingin menjadi bagian dari Sub-Organisasi Media & Teknologi terkeren di SMAN 2 Jakarta?<br />
                            <strong style="color:#00ff88;">Daftarkan dirimu sekarang juga!</strong><br />
                            Klik tombol di bawah ini untuk mengisi formulir pendaftaran online.
                        </p>
                        <a href="https://docs.google.com/forms/d/e/1FAIpQLScNuUw12gR1h12MhwDIgmVTYckFuXqj7oAGeCzLsYSJ9I1DZA/viewform?usp=publish-editor"
                           target="_blank"
                           class="btn-daftar-besar">
                            <i class="fas fa-pen-to-square"></i> ISI FORMULIR PENDAFTARAN
                        </a>
                        <p style="margin-top:18px;font-size:0.8rem;color:#a78bcb;">
                            <i class="fas fa-info-circle"></i> Kamu akan diarahkan ke Google Forms · Pastikan data diisi dengan lengkap dan benar.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <footer class="footer">
                ...
                <span style="font-size:0.6rem;color:#4a2a6a;">
                    ...
                    <br />Designed with Tim MEDIKOM SMAN 2 JAKARTA </i> by Tim Website
        ...
        <div class="digital-card">
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <span class="value">Callysta Aurellia</span>
                </div>
                <div class="info-item">
    ...
    <script>
        (function() {
            ...
            console.log('🧱 MEDIKOM SMAN 2 JAKARTA · Siap dengan dua video (YouTube & lokal) dan semua error telah diperbaiki!');
        })();
    </script>
</body>
</html>
